...
Since this is a community repo, this will not host any code. If you have issue or suggestions, consider opening an issue to let us know. You can hangout in our [GitHub discussions](https://github.com/Tech-Phantoms/community/discussions) and see what the communtiy is talking about, also feel free to open a thread if you have anything on your mind.

This repository also holds our static assets, you can make a clone if you want to use it or use the GitHub link as a CDN(It might get changed to lookout).
...
- If you see any typo in this readme, feel free to open a PR.
